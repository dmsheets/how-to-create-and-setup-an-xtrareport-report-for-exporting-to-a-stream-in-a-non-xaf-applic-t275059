...
Namespace ExportXafReport
    Public Class MyReportObjectSpaceProvider
        ...
        End Sub
        Public Sub DisposeObjectSpaces()
            If objectSpace IsNot Nothing Then
                objectSpace.Dispose()
                objectSpace = Nothing
            End If
        End Sub
        Public Function GetObjectSpace(ByVal type As Type) As IObjectSpace
            If objectSpace Is Nothing Then
                objectSpace = objectSpaceProvider.CreateObjectSpace()
            End If
            Return objectSpace
        End Function
        Public Function CreateObjectSpace(ByVal type As Type) As IObjectSpace
